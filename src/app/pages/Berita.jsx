...
export function Berita() {
  ...
  {news.map((article) => (
    ...
    <Card
      key={article.id}
      className="flex flex-col h-full border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group"
    >
      ...
      <CardContent className="p-6 flex flex-col h-full">
        ...
        <h3 className="mb-3 text-[#191919] font-semibold leading-snug line-clamp-2 min-h-[48px] group-hover:text-[#AE8737] transition">
          {article.title}
        </h3>
