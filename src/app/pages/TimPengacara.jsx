        ...
        {selectedLawyer && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-50 w-full max-w-xl bg-white rounded-xl p-10 shadow-2xl text-center max-h-[90vh] overflow-y-auto"
            >
              <button
                onClick={() => setSelectedLawyer(null)}
              ...
              <img
                ...
                className="w-40 h-40 object-cover rounded-full mx-auto mb-6 shrink-0 border-4 border-[#AE8737]"
              />
              ...
              <div className="flex justify-center gap-6 mt-8">
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-[#AE8737] hover:text-white transition-colors"
                >
