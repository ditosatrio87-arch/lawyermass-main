  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-24">
      <div className="max-w-3xl mx-auto px-6">
        ...
        {/* Result */}
        {result && (
          <div className="bg-white shadow-2xl rounded-2xl p-8 border border-green-200">{/* STATUS VERIFIED */}
<div className="mb-8">
  ...
  <div className="bg-green-50 border border-green-200 rounded-xl p-5">
    <p className="text-slate-700 leading-relaxed">
      Dokumen ini telah berhasil diverifikasi dan tercatat secara resmi
      dalam sistem administrasi digital <b>M.AS Law Firm</b>.
